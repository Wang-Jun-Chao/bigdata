package wjc.bigdata.flink.graphapi;
...
public class BatchJob {
    ...
    private final static String SRC_ID = "s15";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple2<String, Double>> airportVertices = env
                .readCsvFile(PathUtils.workDir("nodes.csv")).types(String.class, Double.class);

        DataSet<Tuple3<String, String, Double>> airportEdges = env
                .readCsvFile(PathUtils.workDir("edges.csv"))
        ...
        Graph<String, Double, Double> result = graph.runVertexCentricIteration(
    ...
    final static class SSSPComputeFunction extends ComputeFunction<String, Double, Double, Double> {
        ...
        public void compute(Vertex<String, Double> vertex, MessageIterator<Double> messages) throws Exception {
            double minDistance = (vertex.getId().equals(SRC_ID)) ? 0d : Double.POSITIVE_INFINITY;
