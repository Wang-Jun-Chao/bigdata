 ...
 * class loading: {@code 'ignite.{sh|bat} example-ignite.xml'}.
 * <p>
 * Alternatively you can run {@link wjc.bigdata.ignite.common.ExampleNodeStartup} in another JVM which will start node with
