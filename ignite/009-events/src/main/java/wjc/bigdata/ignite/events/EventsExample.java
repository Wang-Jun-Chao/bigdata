...
package wjc.bigdata.ignite.events;
 ...
 * just like in {@code example-ignite.xml} file.
 * <p>
 * Remote nodes should always be started with configuration: {@code 'ignite.sh example-ignite.xml'}.
 * <p>
 * Alternatively you can run {@link wjc.bigdata.ignite.common.ExampleNodeStartup} in another JVM which will start
 * node with {@code example-ignite.xml} configuration.
 */
