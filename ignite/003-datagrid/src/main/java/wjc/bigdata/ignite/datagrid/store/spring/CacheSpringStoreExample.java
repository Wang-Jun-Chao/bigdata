...
package wjc.bigdata.ignite.datagrid.store.spring;
 ...
 *     <li>Start a few nodes using 000-startup ExampleNodeStartup.</li>
 *     <li>Start example using {@link CacheSpringStoreExample}.</li>
 * </ul>
 * <p>
 * Remote nodes can be started with 000-startup ExampleNodeStartup in another JVM which will
