 ...
 * <p>
 * Alternatively you can run {@link wjc.bigdata.ignite.common.ExampleNodeStartup} in either same or another JVM.
 */
public class SqlDdlClusterExample {
    /**
     * Dummy cache name.
     */
    ...
    public static void main(String[] args) throws Exception {
        try (Ignite ignite = Ignition.start("example-ignite-cluster.xml")) {
